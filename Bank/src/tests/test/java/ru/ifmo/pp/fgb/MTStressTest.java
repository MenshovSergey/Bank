package tests.test.java.ru.ifmo.pp.fgb;
...
import tests.main.java.ru.ifmo.pp.fgb.Bank;
import tests.main.java.ru.ifmo.pp.fgb.BankImpl;
...
public class MTStressTest extends TestCase {
    ...
    private static final long MEAN = 1000;
    private static final int AMT = 1000; // AMT << MEAN, so that probability of over/under flow is negligible
